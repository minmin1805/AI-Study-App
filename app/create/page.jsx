...
function Create() {
    ...
    /**
     * Use to save user input and generate course layout using
     */
  ...
  return (
    <div className='flex flex-col items-center p-5 md:px-24 ls:px-36 mt-20'>
        ...
        <div className='flex justify-between w-full mt-32'>
            ...
            {step==0? <Button onClick={()=> setStep(step+1)}>Next</Button>: <Button disabled={loading} onClick={GenerateCourseOutline}>
